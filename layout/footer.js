...
export default function Footer() {
  ...
  const AlertSuccess = () => {
    Swal.fire({
      ...
      icon: "success",
      text: "Thank you for subscribing! 🌟 Your journey to exclusive offers and updates has just begun. Welcome to the family!",
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        ...
        process.env.NEXT_PUBLIC_SUB_Emailjs_TEMPLATE_ID,
        form.current,
      ...
      <footer className="industify_fn_footer">
        <div className="top_footer">
          <div
            ...
            style={{ background: "url(img/service/single/s7.jpg)" }}
          ></div>
          {/* <!-- SUBSCRIBE --> */}
            ...
            <div className="container">
              <div className="subscribe_in">
                <div className="s_left">
                  ...
                  <p>
                    Subscribe and unlock exclusive sales and save up to 30%!
                  </p>
                </div>
