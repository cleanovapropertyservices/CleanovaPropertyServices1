		...
		<>
			...
			<Layout>
						...
						<div className="title_holder">
							...
							<div className="industify_fn_breadcrumbs">
								<ul>
									...
									<li><span className="bread-current"> Residential Cleaning</span></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div className="industify_fn_sidebarpage">
						...
						<div className="s_inner">
							...
							<div className="industify_fn_leftsidebar">
								<ul className="industify_fn_service_list">
									<li>
										<div className="item" id="rental-property-cleaning">
											<div className="item_in">
												...
												<div className="title">
													<h3><Link href="/service-single-9"><a>RENTAL PROPERTY CLEANING</a></Link></h3>
									...
									<li>
										<div className="item" id="move-out-cleaning-end-of-tenancy-cleaning">
											<div className="item_in">
												<div className="img_holder">
												...
												<div className="title">
													<h3><Link href="/service-single-8"><a>MOVE OUT CLEANING & END OF TENANCY CLEANING</a></Link></h3>
													<p>Our manufacturing services provide assurance to clients that their people, processes, and products are as safe and efficient as possible. From logistics and compliance, to</p>
												</div>
											</div>
										</div>
									...
									<li>
										<div className="item" id="pre-tenancy-cleaning-checks">
											<div className="item_in">
												<div className="img_holder">
												...
												<div className="title">
													<h3><Link href="/service-single-7"><a>PRE TENANCY CLEANING & CHECKS</a></Link></h3>
									...
									<li>
										<div className="item" id="pre-sale-cleaning">
											<div className="item_in">
												<div className="img_holder">
												...
												<div className="title">
													<h3><Link href="/service-single-6"><a>PRE SALE CLEANING</a></Link></h3>
									...
									<li>
										<div className="item" id="walls-ceiling-cleaning">
											<div className="item_in">
												<div className="img_holder">
												...
												<div className="title">
													<h3><Link href="/service-single-5"><a>WALLS & CEILING CLEANING</a></Link></h3>
									...
									<li>
										<div className="item" id="mould-mildew-cleaning">
											<div className="item_in">
												<div className="img_holder">
												...
												<div className="title">
													<h3><Link href="/service-single-4"><a>MOULD & MILDEW CLEANING</a></Link></h3>
                  ...
                  <li>
										<div className="item" id="deck-cleaning-path-cleaning-house-washing">
											<div className="item_in">
												<div className="img_holder">
													<div className="img_abs" style={{ "backgroundImage": "url(img/service/single/4.jpg)" }}></div>
													<Link href="/service-single-4"><a></a></Link>
												...
												<div className="title">
													<h3><Link href="/service-single-4"><a>DECK CLEANING, PATH CLEANING & HOUSE WASHING</a></Link></h3>
													<p>Get your medical device tested and into the hands of your customers faster than ever before. Time to market starts with partnership, and for more</p>
												</div>
											</div>
										</div>
							...
							<div className="industify_fn_rightsidebar">
								...
								<div className="service_list_as_function">
									...
									<div className="list_holder">
										<ul>
											<li><Link href="/service-single-9"><a>RENTAL PROPERTY CLEANING</a></Link></li>
											<li><Link href="/service-single-8"><a>MOVE OUT CLEANING & END OF TENANCY CLEANING</a></Link></li>
											<li><Link href="/service-single-7"><a>PRE TENANCY CLEANING & CHECKS</a></Link></li>
											<li><Link href="/service-single-6"><a>PRE SALE CLEANING</a></Link></li>
											<li><Link href="/service-single-5"><a>WALLS & CEILING CLEANING</a></Link></li>
											<li><Link href="/service-single-4"><a>MOULD & MILDEW CLEANING</a></Link></li>
											<li><Link href="/service-single-3"><a>DECK CLEANING, PATH CLEANING & HOUSE WASHING</a></Link></li>
