									...
									<li>
										<div className="item" id="office-cleaning">
											<div className="item_in">
												...
												<div className="title">
													<h3><Link href="#"><a>OFFICE CLEANING</a></Link></h3>
									...
									<li>
										<div className="item" id="common-area-cleaning">
											<div className="item_in">
												...
												<div className="title">
													<h3><Link href="#"><a>COMMON AREA CLEANING</a></Link></h3>
									...
									<li>
										<div className="item" id="builders-construction-cleaning">
											<div className="item_in">
												...
												<div className="title">
													<h3><Link href="#"><a>BUILDERS & CONSTRUCTION CLEANING</a></Link></h3>
									...
									<li>
										<div className="item" id="schools-education-provider-cleaning">
											<div className="item_in">
												...
												<div className="title">
													<h3><Link href="#"><a>SCHOOLS & EDUCATION PROVIDER CLEANING</a></Link></h3>
									...
									<li>
										<div className="item" id="supermarket-retail-cleaning">
											<div className="item_in">
												...
												<div className="title">
													<h3><Link href="#"><a>SUPERMARKET & RETAIL CLEANING</a></Link></h3>
									...
									<li>
										<div className="item" id="public-facility-cleaning">
											<div className="item_in">
												...
												<div className="title">
													<h3><Link href="#"><a>PUBLIC FACILITY CLEANING</a></Link></h3>
                  ...
                  <li>
										<div className="item" id="window-cleaning">
											<div className="item_in">
												...
												<div className="title">
													<h3><Link href="#"><a>WINDOW CLEANING</a></Link></h3>
							...
							<div className="industify_fn_rightsidebar">
								...
								<div className="service_list_as_function">
									...
									<div className="list_holder">
										<ul>
											<li><Link href="#"><a>OFFICE CLEANING</a></Link></li>
											<li><Link href="#"><a>COMMON AREA CLEANING</a></Link></li>
											<li><Link href="#"><a>BUILDERS & CONSTRUCTION CLEANING</a></Link></li>
											<li><Link href="#"><a>SCHOOLS & EDUCATION PROVIDER CLEANING</a></Link></li>
											<li><Link href="#"><a>SUPERMARKET & RETAIL CLEANING</a></Link></li>
											<li><Link href="#"><a>PUBLIC FACILITY CLEANING</a></Link></li>
											<li><Link href="#"><a>WINDOW CLEANING</a></Link></li>
										</ul>
									</div>
								</div>
								{/* /Service List */}
