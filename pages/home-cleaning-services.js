				...
				<div className="industify_fn_sidebarpage">
								...
								<ul className="industify_fn_service_list">
									<li>
										<div className="item" id="lease-property-sanitation">
											<div className="item_in">
												...
												<div className="title">
													<h3><Link href="#"><a>Lease Property Sanitation</a></Link></h3>
									...
									<li>
										<div className="item" id="post-occupancy-cleanup">
											<div className="item_in">
												<div className="img_holder">
													<div className="img_abs" style={{ "backgroundImage": "url(img/service/single/8.png)" }}></div>
													<Link href="#"><a></a></Link>
												</div>
												<div className="title">
													<h3><Link href="#"><a>Post-Occupancy Cleanup</a></Link></h3>
									...
									<li>
										<div className="item" id="pre-occupancy-scrub-down-inspection">
											<div className="item_in">
												...
												<div className="title">
													<h3><Link href="#"><a>Pre-Occupancy Scrub-down and Inspection</a></Link></h3>
									...
									<li>
										<div className="item" id="cleaning-services-before-property-sale">
											<div className="item_in">
												<div className="img_holder">
													<div className="img_abs" style={{ "backgroundImage": "url(img/service/single/4.png)" }}></div>
													<Link href="#"><a></a></Link>
												</div>
												<div className="title">
													<h3><Link href="#"><a>Cleaning Services before Property Sale</a></Link></h3>
									...
									<li>
										<div className="item" id="detailed-cleaning-kitchens-bathrooms-ovens">
											<div className="item_in">
												<div className="img_holder">
													<div className="img_abs" style={{ "backgroundImage": "url(img/about/Steven1.png)" }}></div>
													<Link href="#"><a></a></Link>
												</div>
												<div className="title">
													<h3><Link href="#"><a>Detailed Cleaning of Kitchens, Bathrooms, and Ovens</a></Link></h3>
									...
									<li>
										<div className="item" id="wall-ceiling-sanitation">
											<div className="item_in">
												<div className="img_holder">
													<div className="img_abs" style={{ "backgroundImage": "url(img/service/single/11.png)" }}></div>
													<Link href="#"><a></a></Link>
												</div>
												<div className="title">
													<h3><Link href="#"><a>Wall and Ceiling Cleaning</a></Link></h3>
                  ...
                  <li>
										<div className="item" id="mildew-mould-remediation">
											<div className="item_in">
												<div className="img_holder">
													<div className="img_abs" style={{ "backgroundImage": "url(img/service/single/10.png)" }}></div>
													<Link href="#"><a></a></Link>
												</div>
												<div className="title">
													<h3><Link href="#"><a>Mildew and Mould Remediation</a></Link></h3>
                  ...
                  <li>
										<div className="item" id="house-deck-pathway-power-washing">
											<div className="item_in">
												<div className="img_holder">
													<div className="img_abs" style={{ "backgroundImage": "url(img/service/single/1.png)" }}></div>
													<Link href="#"><a></a></Link>
												</div>
												<div className="title">
													<h3><Link href="#"><a>House, Deck, and Pathway Power Washing</a></Link></h3>
									...
									<li>
										<div className="item" id="transparent-surface-cleanup">
											<div className="item_in">
												...
												<div className="title">
													<h3><Link href="#"><a>Transparent Surface (Window) Cleanup</a></Link></h3>
								...
								<div className="service_list_as_function">
									...
									<div className="list_holder">
										<ul>
											...
											<li><Link scroll={false} href="#wall-ceiling-sanitation"><a>Wall and Ceiling Cleaning</a></Link></li>
