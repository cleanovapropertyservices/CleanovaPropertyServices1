...
const Services = dynamic(() => import("../components/Home/HomeServices"), {
  ssr: false,
});
                ...
                <div className="leftpart">
                  <div className="title_holder">
                    ...
                    <p>
                      ...
                      brilliance and attention to detail.
                    </p>
                    <p>
                      Our commitment goes beyond mere cleaning. Every project we
                      undertake showcases our passion for excellence, mirroring
                      our dedication to quality and client satisfaction. With
                      Cleanova, expect a standard that always goes beyond.
                    </p>
                  </div>
                ...
                <div className="rightpart">
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className="abs_img"
                        data-bg-img="img/about/Steven1.png"
                        style={{
                          backgroundImage: "url(img/about/Steven1.png)",
                        }}
                      ></div>
                    </div>
                    <div
              ...
              <div className="awr_inner">
                <div className="left_part">
                  <div className="title_holder">
                    ...
                    <p>
                      At CleanovaP.S., we don't just clean; we transform spaces.
                      Having refined our skills over half a decade, we're more
                      than just a cleaning service. We're a promise of
                      excellence. From bustling commercial hubs to personal
                      sanctuaries at home, our comprehensive range of services
                      caters to a vast spectrum of needs, ensuring every corner
                      doesn't just shine but resonates with impeccable quality.
                    </p>
                    <p>
                      Choosing Cleanova means choosing unwavering dedication.
                      Our team, armed with top-tier certifications and the
                      latest industry knowledge, approaches each task with
                      unmatched precision and passion. Whether it's a deep
                      sterilization or a meticulous carpet care, we bring in the
                      same commitment to quality and client satisfaction. With
                      Cleanova, you're not just getting a clean space; you're
                      experiencing a new standard of brilliance.
                    </p>
                  </div>
                        ...
                        <ul>
                          ...
                          <li>
                            <div className="item">
                              ...
                              <p>Insured with BizCover up to $10 million.</p>
                            </div>
                          </li>
                        </ul>
                      </div>
          ...
          <div className="container">
            <div className="cta_holder">
              <div className="title_holder">
                ...
                <p>
                Embark on a journey to pristine living. Book today for a complimentary cleaning assessment.
                </p>
              </div>
